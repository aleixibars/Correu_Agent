...
- Processament d'adjunts amb IA: llegir el contingut d'un PDF o d'una imatge per a triar el fil o per a redactar-ne l'esborrany. Llistar-los, previsualitzar-los i descarregar-los sí que hi és (§2).
