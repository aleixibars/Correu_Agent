...
// Model choice: latest Opus, not Sonnet — decided explicitly in the grilling
// session for this repo (context.md §12) to prioritize implementation
// quality over CI cost while the pipeline is being validated here.
export const claudeAgent = () =>
  sandcastle.claudeCode("claude-opus-5", {
    env: {
